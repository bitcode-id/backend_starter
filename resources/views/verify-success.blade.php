...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sukses verifikasi email</title>
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1">
                        <div class="col-span-1 rounded p-4 m-2 shadow">
                            <h2 class="text-lg text-center text-gray-700">Email telah berhasil diverifikasi</h2>
                            ...
                            @if(Session::has('message'))
                                <p class="block w-full text-green-500 text-sm font-semibold">{{ Session::get('message') }}</p>
                            @endif
                        </div>
                    </div>
                </div>
